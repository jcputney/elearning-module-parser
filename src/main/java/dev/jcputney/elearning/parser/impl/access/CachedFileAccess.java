...
public final class CachedFileAccess implements FileAccess {
   ...
   * <p>
   * This field serves as the backend file access provider, with caching layers applied in the
   * {@link CachedFileAccess} implementation to optimize the file access process.
   * <p>

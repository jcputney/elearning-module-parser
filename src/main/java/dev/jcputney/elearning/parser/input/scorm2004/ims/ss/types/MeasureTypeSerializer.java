...
/**
 * A custom serializer for the {@link MeasureType} class, enabling its conversion to a JSON string
...
public class MeasureTypeSerializer extends JsonSerializer<MeasureType> {
  ...
  /**
   * Serializes a {@link MeasureType} object into its JSON string representation. Writes the value
   * as a string if it is non-null; otherwise, writes a JSON null.
   *
   * @param value the {@code MeasureType} object to serialize; may be null
   ...
   */
  @Override
  public void serialize(MeasureType value, JsonGenerator gen, SerializerProvider serializers)
      throws IOException {
    if (value != null) {

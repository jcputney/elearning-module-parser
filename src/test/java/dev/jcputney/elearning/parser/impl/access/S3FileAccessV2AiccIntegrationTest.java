...
/**
 * Integration test to verify AICC module parsing with S3 file access using AWS SDK v2, specifically
...
class S3FileAccessV2AiccIntegrationTest {
  ...
  @Test
  void testCachingDoesNotStoreZeroSizes() {
    // Upload a test file
  ...
  void testStreamingProgressWithAiccFiles() throws IOException {
    ...
    assertThat(totalBytesRead).isEqualTo(largeContent
        .toString()

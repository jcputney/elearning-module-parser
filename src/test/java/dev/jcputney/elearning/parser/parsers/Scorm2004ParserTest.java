...
class Scorm2004ParserTest {
  ...
  void detectsEditionFromSchemaVersion_2nd_3rd_4th() throws Exception {
    ...
    assertThat(metadata2.getModuleEditionType()).isEqualTo(ModuleEditionType.SCORM_2004_2ND_EDITION);
    ...
    assertThat(metadata3.getModuleEditionType()).isEqualTo(ModuleEditionType.SCORM_2004_3RD_EDITION);
    ...
    assertThat(metadata4.getModuleEditionType()).isEqualTo(ModuleEditionType.SCORM_2004_4TH_EDITION);
  }

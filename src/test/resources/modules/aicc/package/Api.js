...
$(document).ready(function () {
  API = new function () {
    ...
    this.setPassed = function () {
      setStatus(LESSON_STATUS_PASSED);
    };
    this.setFailed = function () {
      setStatus(LESSON_STATUS_FAILED);
    };
    this.setCompleted = function () {
      setStatus(LESSON_STATUS_COMPLETED);
    };
    this.setBrowsed = function () {
      setStatus(LESSON_STATUS_BROWSED);
    };
    this.setIncomplete = function () {
      setStatus(LESSON_STATUS_INCOMPLETE);
    };
    this.setNotAttempted = function () {
      setStatus(LESSON_STATUS_NOT_ATTEMPTED);
    };
    this.setLessonLocation = function (value) {
